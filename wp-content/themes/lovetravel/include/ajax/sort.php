...
if (empty ($posttype)) {   
	...
	while ( $the_query->have_posts() ) : $the_query->the_post();
		...
		//taxonomy terms
		$terms_destination_package = wp_get_post_terms( $post_id, 'destination-package', $args1 );
		$terms_typology_package = wp_get_post_terms( $post_id, 'typology-package', $args1 );
		$terms_person_package = wp_get_post_terms( $post_id, 'person-package', $args1 );
		$terms_duration_package = wp_get_post_terms( $post_id, 'duration-package', $args1 );
		// END GET ALL DATAS
